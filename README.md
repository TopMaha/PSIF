...
## 📥 นำเข้าข้อมูลเดิมจาก Excel (เฉพาะ Admin)
เมนู **⚙️ ตั้งค่า → นำเข้าข้อมูลเดิมจาก Excel** (เห็นเฉพาะ Admin)
คัดลอกหลายแถวจาก Excel แล้ววาง (คั่นด้วย Tab อัตโนมัติ) เรียงคอลัมน์:

| 1 | 2 | 3 | 4 | 5 | 6 | 7 |
|---|---|---|---|---|---|---|
| วันที่ลงข้อมูล | ชื่อพนักงาน | รายละเอียด | คำแนะนำการแก้ไข | Safety อนุมัติ (ข้อความ) | การดำเนินการ (จบ/ยัง) | วันที่ปิดจบ |

- วันที่รับทั้ง **พ.ศ.** (15/01/2567) และ **ค.ศ.** (2024-01-15) — แปลงปีให้อัตโนมัติ
- สถานะคำนวณให้เอง: มีวันปิด/“จบ” → เสร็จ · “อนุมัติ” → กำลังดำเนินการ · “ไม่อนุมัติ” → Safety ไม่อนุมัติ · อื่น ๆ → บันทึกเข้าระบบ
- จับคู่ชื่อกับรหัสพนักงานให้อัตโนมัติ (ตัด นาย/นาง/น.ส.) ถ้าไม่พบ จะใช้ชื่อที่วางมา
- ไม่มีรูป (ข้อมูลเก่า) · มีปุ่ม **ตรวจสอบ/พรีวิว** ก่อนยืนยันนำเข้า
