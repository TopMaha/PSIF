...
> เปิด GitHub Pages อัตโนมัติผ่าน GitHub Actions ทุกครั้งที่ push ขึ้น `main`
> (รอบแรกใช้เวลา ~1–2 นาทีหลัง push) — ตอนเปิดครั้งแรกเป็น "โหมดทดลอง"
> ไปที่ ⚙️ ตั้งค่า เพื่อใส่ API URL ให้เป็นฐานข้อมูลออนไลน์ที่แชร์กัน
